...
function generateBotResponse(incomingMessageDiv) {
    ...
    $.ajax({
        type: "POST",
        url: "InicioPage.aspx/AgenteModel",
        ...
        success: function (response) {
            ...
            messageElement.innerText = responde;

        },
        error: function (xhr, ajaxOptions, thrownError) {
            console.log(xhr.status + " \n" + xhr.responseText, "\n" + thrownError);
            messageElement.innerText = "Hubo un error al procesar tu solicitud.";
