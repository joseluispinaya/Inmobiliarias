    ...
    public class DChatBot
    {
        ...
        public Dictionary<string, DataTable> ObtenerEsquemaBD()
        {
            ...
            using (SqlConnection con = ConexionBD.GetInstance().ConexionDB())
            {
                ...
                // Obtener todas las tablas
                DataTable tablas = con.GetSchema("Tables");
                esquemaBD["Tables"] = tablas;

                // Obtener todas las columnas
                DataTable columnas = con.GetSchema("Columns");
                esquemaBD["Columns"] = columnas;

                // Opcional: obtener vistas, procedimientos almacenados, etc.
                DataTable procedimientos = con.GetSchema("Procedures");
                esquemaBD["Procedures"] = procedimientos;
            }
